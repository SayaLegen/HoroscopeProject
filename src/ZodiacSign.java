...
public class ZodiacSign {
    ...
    public static void main(String[] args) {
        ...
        if ((sign.equals("Aries")) || (sign.equals("Leo")) || (sign.equals("Sagittius"))) {
            element = "Fire";
            ...
            element = "Air";
        } else if ((sign.equals("Cancer")) || (sign.equals("Scorio")) || (sign.equals("Pisces"))) {
            element = "Water";
        }
        ...
        System.out.println("You zodiac sign is: " + sign + ".");
        System.out.println("Chinese zodiac sign is: " + chineseSign + ".");
